...
void write_energy_to_file(const char *filename, unsigned long step, double kinetic_energy, double potential_energy, double total_energy) {
    ...
    fprintf(file, "%20s %20s %20s %20s\n",
            "         Time Step", "    Kinetic Energy eV", "    Potential Energy eV", "      Total Energy eV");
    }

    fprintf(file, "%20lu %20.7f %20.7f %20.7f\n",
