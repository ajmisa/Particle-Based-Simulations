...
/**
 * @brief Struct to store parameters for each particle type (e.g., methane, ethane).
 */
struct ParticleType
{
    double mass;      //!< Mass of the particle [amu]
    double epsilon;   //!< Lennard-Jones epsilon [eV]
    double sigma;     //!< Lennard-Jones sigma [A]
};
/**
...
struct Parameters
{
    // Array to store parameters for each particle type (methane, ethane)
    struct ParticleType type[2]; //!< Array to hold methane (index 0) and ethane (index 1) parameters
    ...
    // Mixed interaction parameters for methane-ethane interactions
    double epsilon_mixed;    //!< Lennard-Jones epsilon for methane-ethane interaction [eV]
    double sigma_mixed;      //!< Lennard-Jones sigma for methane-ethane interaction [A]
